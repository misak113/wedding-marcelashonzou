...
var WelcomePage = (function (_super) {
    ...
    WelcomePage.prototype.render = function () {
        return (React.createElement("div", {"className": "welcome"}, React.createElement("div", {"className": "wedding-date"}, "6. 6. 2016", React.createElement("br", null), "Čertousy"), this.notYet() ? React.createElement("div", {"className": "rest-time"}, "Zbývá ", this.state.rest.days
            ...
            : null) : React.createElement("div", {"className": "rest-time bigger"}, "Už jsou svoji :)"), React.createElement("div", {"className": "time"}, moment(this.state.now).format('YYYY-MM-DD hh:mm:ss')), React.createElement("div", {"className": "info"}, "Jestliže si někdo se svatebním darem hlavu láme, ", React.createElement("br", null), "tak vězte, že už doma skoro všechno máme.", React.createElement("br", null), "A proto Vám malý tip můžeme dát, ", React.createElement("br", null), "jelikož se budeme brát, ", React.createElement("br", null), "potěší nás příspěvek v jakékoli výši, ", React.createElement("br", null), "který nám rozpočet na domácnost zvýší.", React.createElement("br", null), "Děkujeme"), React.createElement("div", {"className": "fb-comments", "data-href": "http://www.marcelashonzou.cz/", "data-numposts": "5"})));
    };
